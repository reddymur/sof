...
int tplg_parse_ipc3_buffer(struct tplg_context *ctx,
...
int tplg_parse_ipc3_asrc(struct tplg_context *ctx,
...
int tplg_parse_ipc3_process(struct tplg_context *ctx,
		      struct sof_ipc_comp_process *process,
		      struct sof_ipc_comp_ext *comp_ext);
int tplg_new_process(struct tplg_context *ctx, struct sof_ipc_comp_process *process,
		struct snd_soc_tplg_ctl_hdr *rctl);
